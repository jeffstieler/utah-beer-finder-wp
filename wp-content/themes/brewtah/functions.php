<?php
/**
 * Brewtah functions and definitions
 *
 * @package Brewtah
 */
...
function brewtah_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'brewtah_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif; // brewtah_setup
add_action( 'after_setup_theme', 'brewtah_setup' );
...
add_action( 'widgets_init', 'brewtah_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function brewtah_scripts() {
	wp_enqueue_style( 'brewtah-style', get_stylesheet_uri() );

	wp_enqueue_script( 'brewtah-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'brewtah-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
